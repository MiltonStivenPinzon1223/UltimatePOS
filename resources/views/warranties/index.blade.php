...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.warranties') &nbsp; <button style='font-size:36px;color:red'><i class='fab fa-youtube id='modal-video-tutorial' data-toggle="modal" data-target="#stack"></i></button>
     ...
     <div class="modal-dialog">
        <div class="modal-content" style="padding-bottom: 40px">
            ...
            <div class="modal-body">
                ...
                <p id="description-tutorial">Cree Garantias para sus productos</p>
