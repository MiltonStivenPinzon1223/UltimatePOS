     ...
     <div class="modal-dialog">
        <div class="modal-content" style="padding-bottom: 40px">
            ...
            <div class="modal-body">
                ...
                <p id="description-tutorial">Cree Cuentas para sus pagos, gastos y finanzas</p>
                                ...
                                <div class="tab-pane active" id="other_accounts">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                    <button type="button" class="tw-dw-btn tw-bg--to-r tw-from-indigo-600 tw-to-blue-500 tw-font-bold tw-text-black tw-border-none tw-rounded-full btn-modal pull-right"
